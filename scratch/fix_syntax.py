...
old_block = """            **balancing_kwargs(  # type: ignore[arg-type]
                policy=policy,
                ,
                venues=[TrainingVenue(band=MANSION_BAND, map_id=TRAINING_MAP, walk_to_grass=lambda *_args: 1, heal_and_return=lambda *_args: None, is_in_center=lambda raw: raw.map_id == CENTER_MAP, move_slot=lambda _raw: 1), TrainingVenue(band=
                    GrindingArea(
...
new_block = """            **balancing_kwargs(  # type: ignore[arg-type]
                policy=policy,
                venues=[
                    ...
                    TrainingVenue(band=GrindingArea(
                        area_id="digletts_cave",
                        minimum_encounter_level=15,
                        maximum_encounter_level=21,
                        rare_maximum_encounter_level=31,
