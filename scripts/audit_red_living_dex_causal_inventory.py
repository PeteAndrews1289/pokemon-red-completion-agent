...
_PROVIDER_SUPPORT = runpy.run_path(
    ...
    run_name="red_living_dex_causal_inventory_support",
)
...
class _Parser(argparse.ArgumentParser):
    def error(self, message: str) -> Never:
        del message
        raise CausalInventoryCensusError("arguments")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        return 0
    except CausalInventoryCensusError as error:
        stage = error.stage
...
def _support(name: str) -> Any:
    try:
        ...
        raise CausalInventoryCensusError("support_binding") from None
