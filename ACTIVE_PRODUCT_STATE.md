...
| Blocker | Scenario supply and local execution engineering are no longer the immediate blockers. The V2 freezer, exhausted-root check, selected-venue reauthentication, and crash journal are locally qualified. Publication and exact-head green CI are required before one zero-effect private freeze; no authentic V2 capture or outcome exists yet. |
