...
| Blocker | PRs 228/229 are merged and ba5a01d0 passed exact-main CI, but its launch reader incorrectly requires two reserves. The bounded correction accepts the unchanged valid one-reserve plan and passes 26 focused tests plus real complete action-free recipe replay and prior/corpus basis dry run. Qualify this corrected consumer before input. No trial, new outcome, fit or fit-basis publication was consumed by either diagnostic. |
