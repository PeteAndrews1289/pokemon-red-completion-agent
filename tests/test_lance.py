...
def test_lance_source_contract_is_exact() -> None:
    ...
    assert LANCE_RNG_DELAY_FRAMES == 1
    assert LANCE_SAFE_HP == 110
...
def test_lance_receipt_reconstructs_party_and_policy() -> None:
    turns = (
        ...
        LanceTurn(0x59, 56, 100, 110, 0, (1, 1, 0, 1), 2, 1),
        LanceTurn(0x59, 56, 1, 110, 0, (1, 1, 0, 1), 2, 1),
        LanceTurn(0x59, 56, 100, 110, 0, (1, 1, 0, 1), 2, 2),
        LanceTurn(0xAB, 60, 100, 110, 0, (1, 1, 0, 1), 4, 3),
        LanceTurn(0x42, 62, 100, 110, 0, (1, 1, 0, 1), 2, 4),
    )
