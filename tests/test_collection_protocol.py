...
def test_final_campaign_identity_has_public_golden_values() -> None:
    ...
    assert (
        ...
        == "efcade175e72d50c3ecca4b752153b711c445d1211df11c96bc49785c8618d3f"
    )
    assert (
        registry.execution.source_bundle_sha256
        == "e856d236091d3f5d7982e4c1825b502b45d3566782139085a5d1a7ccf859164c"
    )
    assert (
    ...
    assert (
        ...
        == "d866ec7cc3b99f86a99d453b35bab6c8730d6fd124fd99b608ffad71739d6851"
    )
    assert (
        first.assignment_id
        == "3e8f34a65478bb30c2a807b99c82f9be207f61a5fa097bab398a2a948af93502"
    )
