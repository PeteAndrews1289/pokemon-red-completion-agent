...
def test_tracked_registry_is_canonical_frozen_and_preassigned() -> None:
    ...
    assert len(registry.schedule.battle_plan_ids) == 63
    ...
    assert (
        ...
        == "fde5c84d709effcf9156435ddd8c29a1038d27f953b2a5c844dbdea20fcda3a1"
    )
    assert (
        registry.schedule_dry_run.schedule_sha256
        == "4c33d545f61735f331e645d1e1e70bbfba1bc083e004c7b4748025258af33a98"
    )
...
def test_final_campaign_identity_has_public_golden_values() -> None:
    ...
    assert len(payload) == 6337
    assert (
        registry.registry_sha256
        == "645fc80875c96c801cd185631d10ab272d47d3fb13ef9b0118037bf9e5fcbe13"
    )
    assert (
        registry.execution.source_bundle_sha256
        == "30be0eab1569004fdfb37d0302e11d41da50dd60bd6b90f40154cb2a8f8257ab"
    )
    assert (
    ...
    assert (
        ...
        == "414f3fa426501ceb747a1212b6a896cbf76da2cd4305146fdf8614867c166475"
    )
    assert (
        first.assignment_id
        == "42d1d9d8f54bed771206a144552cffa86db2d625f7d99fdcd4941a4f39659291"
    )
...
def test_schedule_expansion_is_deterministic_bounded_and_content_addressed() -> None:
    ...
    assert (
        run.schedule_sha256
        == "4a8d3d425adc4ec26f76390461936019374ae0ea695ef6b60b50f2fff8b37313"
    )
