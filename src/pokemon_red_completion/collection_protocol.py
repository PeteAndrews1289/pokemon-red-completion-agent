...
COLLECTION_REGISTRY_RELATIVE_PATH = "configs/red-battle-collection-v4.json"
COLLECTION_REGISTRY_DIGEST_RELATIVE_PATH = (
    "configs/red-battle-collection-v4.digest.json"
)
...
_EXPECTED_COLLECTION_ID = "red-battle-heldout-v4"
_EXPECTED_REGIME = "within_game"
_EXPECTED_DRY_RUN_ID = "red-battle-schedule-dry-run-v4"
