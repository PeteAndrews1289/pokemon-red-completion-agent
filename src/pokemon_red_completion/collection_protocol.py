...
COLLECTION_REGISTRY_RELATIVE_PATH = "configs/red-battle-collection-v6.json"
COLLECTION_REGISTRY_DIGEST_RELATIVE_PATH = (
    "configs/red-battle-collection-v6.digest.json"
)
...
_EXPECTED_COLLECTION_ID = "red-battle-heldout-v6"
_EXPECTED_REGIME = "within_game"
_EXPECTED_DRY_RUN_ID = "red-battle-schedule-dry-run-v6"
