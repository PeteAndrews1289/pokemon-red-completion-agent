...
COLLECTION_REGISTRY_RELATIVE_PATH = "configs/red-battle-collection-v3.json"
COLLECTION_REGISTRY_DIGEST_RELATIVE_PATH = (
    "configs/red-battle-collection-v3.digest.json"
)
...
_EXPECTED_COLLECTION_ID = "red-battle-heldout-v3"
_EXPECTED_REGIME = "within_game"
_EXPECTED_DRY_RUN_ID = "red-battle-schedule-dry-run-v3"
