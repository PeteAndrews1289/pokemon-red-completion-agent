...
COLLECTION_REGISTRY_RELATIVE_PATH = "configs/red-battle-collection-v9.json"
COLLECTION_REGISTRY_DIGEST_RELATIVE_PATH = (
    "configs/red-battle-collection-v9.digest.json"
)
...
_EXPECTED_COLLECTION_ID = "red-battle-heldout-v9"
_EXPECTED_REGIME = "within_game"
_EXPECTED_DRY_RUN_ID = "red-battle-schedule-dry-run-v9"
