# Historical archive — superseded September 10, 2026

Earlier dashboard reports and specifications follow. Their status claims and commands
are historical, not current guidance. Use the current dashboard guide instead.
...
same-state paired launcher passed **37/37** focused checks. The first live pair is now complete:
both arms chose `manage_storage`, increased storage headroom **2→20**, preserved all 24 specimens,
and used exactly **36 actions / 4,512 frames**. The dashboard reports `equivalent`, keeps
deterministic goal ordering authoritative, and shows the three integration counters at **2/2,
2/2 and 18/18**. Its next rail is the action-free multi-goal curriculum inventory. It must not imply
that one tied development episode trained a model or demonstrated transfer.
>
...
> STATE LOADS · AT MOST ONE TERMINAL SAVE · NO RETRY AFTER CLAIM → PASS ≥9 WITH ROLE FLOORS 2/6/1 →
> PUBLISH → GREEN EXACT MAIN → FREEZE ONCE → RUN EACH ONCE → ACTION-FREE COMPLETE-DENOMINATOR
> ADMISSION → INTEGRATION/YIELD RECENSUS → SIZE POPULATION CAMPAIGN → FINAL 36/100/3 CAPACITY
> PASS → OUTCOMES → POWERED FIT → UNTOUCHED RED → TEACHER-FREE AUTHORITY → LIVING-DEX
> COMPOSITION → CRYSTAL**. Keep **ENGINEERING EFFECTS: ROM/WORLDS/TEACHER/PREDICTIONS/OUTCOMES/
> FITS 0** and **CAUSAL TRAIN 18/60 · INTEGRATION FIT 1/1 · POWERED FIT 0 · AUTHORITY 0 ·
> TRANSFER 0** visible. Cross out **UNPUBLISHED EXECUTION · CLAIMED-WORLD RETRY · CLONE/REHASH
> AS INDEPENDENCE · CALL ROOTS TRAINING DATA · LAUNCH 103 BLINDLY · CRYSTAL NOW · FULL REPLAY**.
> Link the [supply contract](../red-living-dex-powered-lineage-supply.md).
>
> **Previous rail:** Show **PR 119 → MAIN F1FC3812 → CI 33355147814/1 GREEN → ONE ACTION-FREE
> CENSUS → 81 AUTHENTICATED · 29 CONSUMED · 43 UNUSED LINEAGES · 36 WITH ANY SCENARIO → TRAIN
> 14/36 · ATTEMPTS 28/72 · DEVELOPMENT 22/100 · CONTINGENCY 0/3 → TOTAL DEFICIT 103 → TEMPLATE/
> LOCATION/KIND/FAMILY/PRESSURE FLOORS FAIL → EXACT WITNESS ABSENT → GAMEPLAY CLOSED**. Keep
> **ACTIONS/FRAMES/CLAIMS/TEACHERS/PREDICTIONS/OUTCOMES/FITS 0** visible. Continue **PATH-FREE
> RESULT → AUDIT EXISTING CLEAN-POWER GENERATOR → V2 MULTI-PARTITION SUPPLY DESIGN → BOUNDED
> ONE-SHOT YIELD TRANCHE → ACTION-FREE RECENSUS → SCALE GENUINE LINEAGES → 60 → ONE POWERED FIT
> → UNTOUCHED RED → TEACHER-FREE AUTHORITY → LIVING-DEX COMPOSITION → CRYSTAL**. Keep **CAUSAL
> TRAIN 18/60 · INTEGRATION FIT 1/1 · POWERED FIT 0 · AUTHORITY 0 · TRANSFER 0** visible. Cross
> out **WEAKEN V2 · CLONE/REHASH AS INDEPENDENCE · CURRENT-BANK GAMEPLAY · OUTCOME COLLECTION ·
> DEVELOPMENT OPEN · R0 REFIT · SEALED RED · CRYSTAL NOW · FULL REPLAY**. Link the
> [capacity result](../evidence/red-living-dex-clustered-powered-v2-capacity-result-v1-2026-08-31.json).
>
> **Previous rail:** Show **MAIN 72F57D0A → CI 33322464644/1 GREEN → SUCCESSOR ORDINALS 2–7 ONCE
> EACH → 4 SETTLED + 2 SETUP-ONLY → YIELD 4/6 → 12,209 ACTIONS · 609,272 FRAMES · 600.789
> SECONDS · 23.97 EXAMPLES/HOUR → ALL SIX CLAIMS CONSUMED → CORPUS 12 LINEAGES · ALL 7 KINDS ·
> 36/36 SUPPORTED CANDIDATES · SELECTED RANK 10/16 · SUCCESS 2 / FAILURE 10 → THROUGHPUT PASS ·
> POWERED INFORMATION FAIL**. Continue **PATH-FREE RESULT → EXACT-MAIN CI → UNTOUCHED ORDINALS
> 8–15 ONCE EACH IN FIXED ORDER → COMPLETE-SUCCESSOR AUDIT → FREEZE CLUSTERED POWERED V2 → 60
> → UNTOUCHED RED CONTROLS → BOUNDED TEACHER-FREE AUTHORITY → LIVING-DEX COMPOSITION → FREEZE
> TITLE-NEUTRAL BUNDLE → CRYSTAL**. Keep **CAUSAL TRAIN 12/60 · INTEGRATION FIT 1/1 · POWERED
> FIT 0 · AUTHORITY 0 · TRANSFER 0** visible. Cross out **RETRY · SUBSTITUTION · OUTCOME
> BALANCING · DEVELOPMENT · R0 REFIT · MODEL-CONTROLLED GAMEPLAY · ROUTE PATCH IN BATCH ·
> TEACHER TARGET · SEALED RED · CRYSTAL NOW · FULL REPLAY**. Link the
> [six-card result](../evidence/red-living-dex-r1-six-card-throughput-result-v1-2026-08-30.json).
>
> **Previous rail:** Show **PR 114 → MAIN F5097982 → CI 33320429925/1 GREEN → COMPLETE AUTHENTIC
> TRAIN DENOMINATOR 8/8 → ONE CLAIM-FIRST LEARNER INVOCATION → SUPPORTED CANDIDATES 24/24 ·
> VARYING TARGET HEADS 7 · FINITE COEFFICIENTS 225/225 · CONDITION NUMBER 674.12 → IMMUTABLE
> MODEL A211DE9C → BYTE REOPEN ✓ · TYPED REOPEN ✓ → GAMEPLAY PREDICTIONS/DEVELOPMENT/TEACHERS/
> ACTIONS/FRAMES/AUTHORITY/CRYSTAL 0 → R0 COMPLETE**. Keep the rejected launch visible as
> **UNRELATED INITIALIZED STORE → NO CAUSAL ANCHOR → FITS 0 · CLAIMS 0 → CORRECT STORE SELECTED →
> FIRST/ONLY FIT**. Continue **PATH-FREE RESULT → EXACT-MAIN CI → FIXED SUCCESSOR ORDINALS 2–7
> ONCE EACH → ATTEMPTED/SETTLED YIELD + WALL-CLOCK THROUGHPUT + SUPPORT/VARIATION/COST → STOP +
> REORIENT → POWERED CLUSTER DESIGN → 60 → UNTOUCHED RED → FROZEN SUPPORTED REPRESENTATION →
> CRYSTAL → CROSS-GAME LIVING POKEDEX**. Keep **CAUSAL TRAIN 8/60 · INTEGRATION FIT 1/1 ·
> POWERED FIT 0 · AUTHORITY 0 · TRANSFER 0** visible. Cross out **R0 REFIT · ORDINAL 0/1 RETRY ·
> OUTCOME-AWARE REPLACEMENT · DEVELOPMENT · MODEL-CONTROLLED GAMEPLAY · WITHIN-BATCH ROUTE PATCH
> · TEACHER TARGET · FULL REPLAY · CRYSTAL NOW**. Link the
> [fit result](../evidence/red-living-dex-causal-integration-fit-result-v1-2026-08-30.json).
>
> **Current rail:** Show **PR 111 → MAIN ED6066E0 → CI 33298743000/1 GREEN → ONE TRAIN-ONLY
> ACTION-FREE AUDIT → COMPLETE DENOMINATOR 8/8 → LINEAGES 8 · DECISIONS 8 · SELECTED KINDS 6 ·
> SELECTED FEATURE ROWS 8 · SUPPORTED CANDIDATES 24/24 · VARYING TARGET HEADS 7 · FULL SUPPORT
> 8/8 · CENSORING/DEVELOPMENT 0 → FITS/PREDICTIONS/TEACHERS/ACTIONS/FRAMES/CLAIMS 0 → READINESS
> PASS**. Continue **PATH-FREE RESULT → ONE DETERMINISTIC NON-AUTHORITATIVE FIT OVER ALL 8 →
> PRIVATE MODEL + BYTE-IDENTICAL REOPEN → PATH-FREE FIT RECEIPT → REORIENT → BOUNDED UNTOUCHED
> SUCCESSOR BATCH → 60 → UNTOUCHED RED → FROZEN SUPPORTED REPRESENTATION → CRYSTAL → CROSS-GAME
> LIVING POKEDEX**. Keep **CAUSAL TRAIN 8/60 · POWERED FIT 0 · AUTHORITY 0 · TRANSFER 0** visible.
> Cross out **AUDIT RETRY · ROW DROPPING · DEVELOPMENT · GAMEPLAY IN FIT GATE · TRAINING-ERROR
> QUALITY CLAIM · TEACHER TARGET · FULL REPLAY · CRYSTAL NOW**. Link the
> [readiness result](../evidence/red-living-dex-causal-integration-readiness-result-v1-2026-08-30.json).
>
> **Current rail:** Show **PR 109 → MAIN 2EA86BCC → CI 33294371591/1 GREEN → SUCCESSOR TRAIN 1
> CLAIMED ONCE → RANDOM COMMITMENT 1 → CONTROLLER ACTIONS 3,322 → EMULATOR FRAMES 146,341 →
> SELECTED-ARM CAUSAL TARGET 1 → TEACHERS/COUNTERFACTUALS/UNSELECTED TARGETS/DEVELOPMENT/
> PREDICTIONS/FITS/RETRIES 0 → DURABLE TERMINAL → 8/60**. Continue **PATH-FREE RESULT →
> EXACT-MAIN CI → ACTION-FREE TRAIN-ONLY READINESS → LINEAGES + KINDS + SUPPORTED FEATURES +
> TARGET VARIATION + CENSORING → PASS: ONE NON-AUTHORITATIVE FIT / FAIL: REORIENT THEN ORDINAL 2
> → 60 → UNTOUCHED RED → FROZEN SUPPORTED REPRESENTATION → CRYSTAL → CROSS-GAME LIVING POKEDEX**.
> Keep **CAUSAL TRAIN 8/60 · POWERED FIT 0 · AUTHORITY 0 · TRANSFER 0** visible. Cross out
> **ORDINAL 0/1 RETRY · ROW DROPPING · FIT BEFORE AUDIT · DEVELOPMENT · TEACHER TARGET · FULL
> REPLAY · CRYSTAL NOW**. Link the
> [ordinal-one result](../evidence/red-living-dex-clustered-successor-train-ordinal-1-result-v1-2026-08-30.json).
>
> **Current rail:** Show **PR 106 → SOURCE D4DA25BE → CI 33284967875/1 GREEN → ONE ACTION-FREE
> FREEZE → 16 TRAIN / 16 LINEAGES + 4 READ-ONLY DEVELOPMENT / 4 LINEAGES → ALL 7 RED KINDS BOTH
> SIDES · MAX 1/LINEAGE · OVERLAP 0 → SCHEDULE 94B1330D · PLAN 93562084 → INDEPENDENT REOPEN ✓ →
> ACTIONS/FRAMES/CLAIMS/BEHAVIORS/TEACHERS/OUTCOMES/PREDICTIONS/FITS 0**. Continue **EXACT-PLAN
> TRAIN CONSUMER → ORDINALS 0–15 ONLY · 16/DEVELOPMENT REJECTED · OLD 0–7 PATH UNCHANGED → FULL
> LOCAL GATE → PUBLISH → EXACT-SOURCE CI → ONE ROM-FREE ZERO-EFFECT PREFLIGHT → REORIENT → TRAIN
> ROWS ONCE → ≥8 AUTHENTIC EXAMPLES → NON-AUTHORITATIVE FIT → 60 → UNTOUCHED RED → CRYSTAL →
> CROSS-GAME LIVING POKEDEX**. Keep **CAUSAL TRAIN 6/60 · POWERED FIT 0 · AUTHORITY 0 · TRANSFER
> 0** visible. Cross out **REFREEZE · SETUP-REHEARSAL REPLACEMENT · DEVELOPMENT EXECUTION ·
> TEACHER TARGET · FULL REPLAY · CRYSTAL NOW**. Link the
> [freeze result](../evidence/red-living-dex-clustered-successor-freeze-result-v1-2026-08-29.json)
> and [consumer qualification](../evidence/red-living-dex-clustered-successor-train-consumer-local-qualification-v1-2026-08-29.json).
>
> **Current rail:** Show **EXACT MAIN 2ADC893C + CI 33279928951/1 GREEN → ACTION-FREE RECENSUS →
> 81 AUTHENTICATED · 13 CONSUMED · 59 UNUSED QUALIFIED · 36 TRAIN · 23 DEVELOPMENT · 55 MENU-
> COMPATIBLE → FRESH 8+4 DEFAULT SCHEDULE · ALL 7 RED KINDS · MAX 1/LINEAGE · OVERLAP 0 →
> ACTIONS/FRAMES/CLAIMS/BEHAVIORS/TEACHERS/OUTCOMES/PREDICTIONS/FITS 0 → SUCCESSOR BOUNDARY LOCAL
> TESTS 49/49 · FULL 5,777 GREEN**. Continue **FIXED 16 TRAIN /16 LINEAGES + 4 READ-ONLY
> DEVELOPMENT/4 LINEAGES → PUBLISH FREEZER → EXACT-SOURCE CI → FREEZE
> ONCE → BIND EXACT PLAN → TRAIN ONLY → ≥8 EXAMPLES → NON-AUTHORITATIVE FIT → 60 → UNTOUCHED RED
> → CRYSTAL**. Keep **CAUSAL TRAIN 6/60 · POWERED FIT 0 · AUTHORITY 0 · TRANSFER 0** visible.
> Cross out **TINY 3-ROW PATCH · SETUP-REHEARSAL SELECTION · PILOT RETRY · DEVELOPMENT OUTCOME ·
> PREMATURE FIT · FULL REPLAY · CRYSTAL NOW**. Link the
> [capacity result](../evidence/red-living-dex-clustered-successor-capacity-v1-2026-08-29.json).
>
> **Current rail:** Show **EXACT MAIN 5656BD63 + CI 33277598103/1 GREEN → FROZEN TRAIN 8/8
> CONSUMED ONCE → 5 SETTLED SELECTED-ARM EXAMPLES + 3 SETUP-ONLY TERMINALS → POSITIVE 2 · NEGATIVE
> 3 · NO-TARGET ATTRITION 3 → MENUS COVER 7 KINDS · SELECTED 4 KINDS → DEVELOPMENT/TEACHER/
> COUNTERFACTUAL/PREDICTION/FIT 0**. Continue **PATH-FREE RESULT → EXACT-MAIN CI → UNUSED
> TRAIN-LINEAGE CENSUS → ATTRITION-AWARE SUCCESSOR → ≥8 EXAMPLES → NON-AUTHORITATIVE FIT → 60 →
> UNTOUCHED RED → FROZEN SUPPORTED REPRESENTATION → CRYSTAL**. Keep **CAUSAL TRAIN 6/60 · POWERED
> FIT 0 · AUTHORITY 0 · TRANSFER 0** visible. Cross out **RETRY · FIVE-ROW FIT · DEVELOPMENT REUSE
> · OUTCOME-AWARE ADMISSION · FULL REPLAY · CRYSTAL NOW**. Link the
> [batch result](../evidence/red-living-dex-clustered-train-batch-result-v1-2026-08-29.json).
>
> **Current rail:** Show **PR 103 → MAIN BEDCC0BB → EXACT CI 33275740732/1 GREEN → AUTHENTIC
> ROM-FREE PREFLIGHT → TRAIN ORDINAL 0 → ROOT READS 1 → PLAN/ROOT/LINEAGE/RUNTIME/PAIR AVAILABLE
> ✓ → CLAIMS/ACTIONS/FRAMES/COMMITMENTS/TEACHERS/PREDICTIONS/OUTCOMES/FITS 0**. Show the launch
> correction honestly: **C LOCALE → PYTHON UTF-8 MODE → BOOTSTRAP FAILED BEFORE SOURCE/PRIVATE
> ACCESS → NORMAL MACOS LOCALE → ONE AUTHENTICATED PREFLIGHT PASS**. Continue **PATH-FREE RECEIPT
> → EXACT-MAIN CI → ONE AUTHENTIC SELECTED ARM → DURABLE TERMINAL → REORIENT → 8 OUTCOMES →
> NON-AUTHORITATIVE FIT → 60+ → UNTOUCHED RED → FROZEN SUPPORTED REPRESENTATION → CRYSTAL**.
> Keep **CAUSAL TRAIN 1/60 · POWERED FIT 0 · AUTHORITY 0 · TRANSFER 0** visible and cross out
> **MORE RUNNER ENGINEERING · DEVELOPMENT ACCESS · TEACHER LABEL · ALTERNATE-ARM TARGET · FULL
> REPLAY**. Link the [path-free result](../evidence/red-living-dex-clustered-train-preflight-result-v1-2026-08-29.json).
>
> **Current rail:** Show **FROZEN PLAN 2A0462B8 → TRAIN-ONLY CONSUMER LOCAL GO → ORDINALS 0–7
> ONLY → SCHEDULE ORDINAL ≠ RED TEMPLATE ORDINAL → UPSTREAM LINEAGE RETAINED → LOGICAL+PHYSICAL
> CLAIM → RANDOM ARM DURABLE BEFORE INPUT → SELECTED OUTCOME ONLY**. Run the crash matrix across
> both setup claims and every causal durable seam; stamp **NO RETRY · NO ARM CHANGE · NO DUPLICATE
> INPUT · DEVELOPMENT INACCESSIBLE · TEACHER/COUNTERFACTUAL TARGETS 0**. Continue **PUBLISH → PR
> CI → EXACT-MAIN CI → ONE ROM-FREE PREFLIGHT → PLAN/ROOT/RUNTIME/PAIR AVAILABLE ✓ → EFFECTS 0 →
> PATH-FREE RECEIPT → REORIENT → FIRST AUTHENTIC TRAIN RUN → 8 OUTCOMES → NON-AUTHORITATIVE FIT
> → 60 → UNTOUCHED RED → CRYSTAL**. Keep **CAUSAL TRAIN 1/60 · POWERED FIT 0 · AUTHORITY 0 ·
> TRANSFER 0** visible.
>
> **Current rail:** Show **PR 101 → MAIN 4190B92B → EXACT CI 33268744819/1 GREEN → ONE ACTION-FREE
> FREEZE → SCHEDULE 35C00F38 → PRIVATE PLAN 2A0462B8 → 8 TRAIN / 8 LINEAGES + 4 DEVELOPMENT / 4
> UNTOUCHED LINEAGES → ALL 7 KINDS BOTH SIDES → OVERLAP 0 → INDEPENDENT ROM-FREE REOPEN ✓ →
> ACTIONS/FRAMES/CLAIMS/TEACHERS/OUTCOMES/FITS 0**. Continue **TRAIN-ONLY CLAIM-FIRST RUNNER →
> LOGICAL + PHYSICAL CLAIM → PRE-INPUT ARM COMMITMENT → ALL CRASH CUTPOINTS → PUBLISH → EXACT CI →
> REORIENT → FIRST AUTHENTIC TRAIN RUN → 8 OUTCOMES → NON-AUTHORITATIVE FIT → SCALE TO 60 →
> UNTOUCHED RED LINEAGES → CRYSTAL**. Cross out **REFREEZE · RECENSUS · DEVELOPMENT EXECUTION ·
> COUNTERFACTUAL LABEL · TEACHER BUTTON LABEL · RUNNER ENGINEERING + GAMEPLAY IN ONE GATE**. Link
> the [freeze result](../evidence/red-living-dex-clustered-schedule-freeze-result-v1-2026-08-29.json)
> and keep **CAUSAL TRAIN 1/60 · POWERED FIT 0 · AUTHORITY 0 · TRANSFER 0** visible.
>
> **Current rail:** Show **CLUSTER CENSUS PASSED → 8 TRAIN / 8 LINEAGES + 4 DEVELOPMENT / 4
> UNTOUCHED LINEAGES → PRIVATE FREEZER + INDEPENDENT VALIDATOR LOCALLY GO → 5,751 TESTS · MYPY
> 313 · REGISTRIES/DOCS/PUBLIC GREEN → REAL PLAN NOT FROZEN → PUBLISH EXACT SOURCE → GREEN CI
> → ONE ACTION-FREE FREEZE + REOPEN → REORIENT → CLAIM-FIRST RUNNER → 8 AUTHENTIC TRAIN
> OUTCOMES → FIRST NON-AUTHORITATIVE FIT → SCALE TO 60 → UNTOUCHED RED LINEAGES → FROZEN
> SUPPORTED REPRESENTATION → CRYSTAL**. Cross out **ARM SELECTION IN FREEZER · FREEZE+EXECUTE
> IN ONE GATE · TEACHER BUTTON LABELS · ROUTINE FULL REPLAY**. Link the
> [freezer qualification](../evidence/red-living-dex-clustered-schedule-freezer-local-qualification-v1-2026-08-29.json)
> and keep **CAUSAL TRAIN 1/60 · POWERED FIT 0 · AUTHORITY 0 · TRANSFER 0** visible.
>
