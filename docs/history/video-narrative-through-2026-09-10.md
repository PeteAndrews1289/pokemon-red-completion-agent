...
# Historical — show the decision changing the game

Show the two offered choices, then the actual recorded result: the newly fitted
head chooses story instead of another heal, and Bruno is defeated in 181 actions
and 17,293 frames. All 30 specimens remain; no item was spent. The old model's
heal preference can be shown as a **shadow recommendation**, not a played control.

Voiceover: "We trained on what the whole attempt accomplished. Then we let the
new model make one real choice. It chose to progress, and the battle skill carried
that choice out. That is a first step toward a player—not the finished player."

Keep the labels visible: four training examples, one correlated control probe,
deterministic low-level skills, no independent win-rate claim, Phase 4 unfinished.
Next comes a different story objective, with new prospective data rather than a
renamed Bruno model. See [audited control](../audits/red-forward-first-choice-probe-2026-09-09.md).

# Historical — the AI can do everything right locally and still miss the goal
...
with **SHA-256 95B59F67…CA31**.

Stamp **MODEL SCORE 0 · CLAIM WRITE 0 · BUTTONS 0 · FRAMES 0 · COUNTERS UNCHANGED · INTERNAL
AUDITS GO · ANTIGRAVITY GO · P0/P1/P2 0**. Explain that route steps and cost are aggregate plan metrics,
not a direction script. The next rail is **FREEZE ONE PUBLIC
...
**ONE FORMAL DEVELOPMENT-OUTCOME-UNUSED ACQUISITION TRAIN ROOT · INITIAL GOALS 3 · MODEL-BLIND
SELECTION · SUPERVISED-TRAIN EXPOSURE ALLOWED · GUARD-ONLY EXPOSURE ALLOWED · NOT UNSEEN**.
Link the
[design receipt](../evidence/paired-red-goal-manager-outcome-screen-design-v1-2026-08-18.json) with
**SHA-256 C8CEA9A42BF5B0DC673195B7898258562ACE3FE92211F1F8D08EC3E3DB460391**.

Show **RESET ARMS 2 · CLAIMED 0 · MAX 3 DECISIONS EACH**. Highlight **PRIMARY: SAFE RETAINED
ACQUISITION ONLY**; gray out **SECONDARY, NOT YET PROVEN: COMPLETION · VERIFIED OUTCOMES ·
CHANGED-STATE REPLANNING**. Briefly show **FIRST ACTION-FREE FREEZE: ARTIFACT ID TOO LONG · PLAN 0
· CLAIM 0 · PREDICTION 0 · ACTION 0**, then **REPAIRED FREEZE SUCCESS**.

Move the rail to `paired-red-goal-manager-outcome-screen-execution-qualification-v1`: **IMPLEMENT
EXECUTE/ADMIT → PUBLISH → EXACT-HEAD GREEN CI → ONE ZERO-ACTION PREFLIGHT → STOP**. Stamp
**GAMEPLAY 0 IN THIS LANE · LATER PAIR NEEDS SEPARATE REORIENTATION**.

Keep **30 TRAIN · 15 DEVELOPMENT · 4 FITS · 3 COMPARISONS · AUTHORITY 0 · TRANSFER 0** and
**PRODUCT-FOCUS-V2 12/2/0/1/1**. Show **PREDICTIONS 0 · CONTROLLER 0 · ADVANCED FRAMES 0 ·
EXECUTIONS 0 · OUTCOMES 0 · COUNTER DELTA 0**.

## Previous August 18 scene: the weights move once; the authority does not
...
DEVELOPMENT-OUTCOME-UNUSED ACQUISITION TRAIN ROOT · MODEL-BLIND SELECTION · EXCLUDE PRIOR
TEACHER-FREE CAMPAIGN/VALIDATION/TEST/SEALED/CLOSED LINEAGES · SUPERVISED-TRAIN + GUARD-ONLY
EXPOSURE ALLOWED AND DISCLOSED**. Match the two arm cards: **IDENTICAL INITIAL STATE · MENU · SEED · POLICY
...
conditional Bide sale. Fast-forward the same run to Agatha: 18/19 objectives and 71/74 battles,
then freeze on fainted Dugtrio beside three unused Revives. Show one Revive moving to Agatha while
two remain locked for Lance. End the montage by replacing **“dirty diagnostic: reached Agatha”**
with the clean receipt: **47,317,703 frames; 74/74 battles; 36/36 objectives; Hall of Fame.** Keep
