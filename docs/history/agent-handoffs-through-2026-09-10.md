...
This document preserves earlier reports, including their original headings and claims.
Nothing below is current guidance, execution authorization or an aggregate result.
See the repository README and current handoff for the active project.
...
[Repair, actual-state check and next step](../work-sessions/2026-09-10-observed-funding.md).
...
[Audit, next steps and session reporting](../audits/red-status-recovery-2026-09-10.md).
...
The actor chooses goals and destinations; deterministic skills still execute mechanics. Historical114 remains separate. No learned combat, independent reliability or transfer claim.
[Session and next step](../work-sessions/2026-09-10-supported-collection.md).
...
The actor chooses goals and destinations; deterministic skills still execute mechanics. Historical114 remains separate. No learned combat, independent reliability or transfer claim.
[Session and next step](../work-sessions/2026-09-10-capture-prerequisites.md).
...
The actor chooses goals and destinations; deterministic skills still execute mechanics. Historical114 remains separate. No learned combat, independent reliability or transfer claim.
[Session and next step](../work-sessions/2026-09-10-observed-local-capture.md).
...
[Bounded session](../work-sessions/2026-09-10-indoor-collection-options.md).
...
[Review and next steps](../work-sessions/2026-09-09-registered-runtime-binding.md). No external-agent audit or usage.
...
[Session package](../work-sessions/2026-09-09-phase5-agent-package.md). Gemini roughly94%five-hour/92%weekly remaining
...
restart point. See [the receipt](../evidence/red-lance-fit-champion-stop-2026-09-09.json).
...
model still has82 fitted examples. See [the result](../evidence/red-model-selected-lance-2026-09-09.json).
...
# Historical — proactive recovery integrated; live qualification next
...
Read [actual bounds, implementation seam and next-session mission](../audits/red-league-resource-management-next-session.md).
...
Read [session audit](../audits/red-resource-fit-and-fixed-damage-2026-09-09.md) and [active state](../../ACTIVE_PRODUCT_STATE.md).
...
Read [probe audit](../audits/red-agatha-controller-probe-2026-09-09.md) and
[next-session plan](../agatha-resource-coverage-next-session.md).
...
See [the actual control audit](../audits/red-forward-first-choice-probe-2026-09-09.md).
...
external reviewer quotas remain unavailable. See [audit](../audits/red-forward-goal-pilot-2026-09-09.md) and
...
See [the forward-goal audit](../audits/forward-goal-learning-2026-09-09.md) and [active state](../../ACTIVE_PRODUCT_STATE.md).
...
[the audit](../audits/red-lance-integration-2026-09-09.md).
...
See [recovery audit](../audits/red-budgeted-trainer-recovery-2026-09-08.md).
...
See [switch-entry audit](../audits/red-switch-entry-screen-2026-09-08.md).
...
See [session audit](../audits/red-native-trainer-story-2026-09-08.md). Next setting: Astra High, Fast off; consequential control
...
## Historical — story admission and stored field capability
...
[Detailed audit and remaining Phase 4 work](../audits/red-earned-resource-continuation-2026-09-08.md).
...
[Static evidence](../evidence/red-trainer-funding-static-qualification-2026-09-08.json). [Session audit and reviewer handoff](../audits/red-trainer-funding-static-qualification-2026-09-08.md).
...
[Audit and next step](../audits/red-mixed-owned-evolution-2026-09-08.md). Recommend Astra Extra High, Fast off.
...
[Audit and exact next step](../audits/red-safe-capture-integration-2026-09-07.md).
...
running in the background. Next follow the [optional-recovery learning plan](../work-sessions/2026-09-07-optional-recovery-learning-plan.md).
...
level 20→21 change in 1,119 actions / 101,171 frames. The pair failed before the baseline arm because
the post-skill observer treated a zero-available-goal Route 11 state as a policy question. A
deterministic replay reproduced the trace and proved collection preservation, semantic change and
...
train/development collisions, and proved an exact eight-root allocation across two venues: **4
Route 11 + 4 Diglett's Cave**. It created no claim, capture, outcome, prediction, fit or authority.

Codex owns the next engineering gate: generalize the train V2 freezer/materializer seam to carry
partition and denominator eight, rederive the exact allocation from the whole bank, bind immutable
outputs and started-before-input identities, hostile-test, publish, and require exact-main green
CI. The next private operation is one zero-effect plan freeze only. Stop and reorient before any
controller input. Reviewers may inspect tracked code and path-free evidence, but receive no ROM,
save, selected-root, private plan or lineage identity.

## Previous override: Codex owned one action-free development capacity census
...
(SHA-256 `27a71899…fc0e1`) records 81 authenticated states, zero frames/effects, and one durable
plan with eight train plus eight untouched development trials, two complete candidates per menu,
balanced 4/4 candidate interventions in each partition, 16 distinct roots, and zero family/root
overlap. Plan `50327b72…0947` and manifest `763951ca…8a47` are immutable. V1, V2, and V3 freezes
are all consumed and cannot retry.

Codex owns only the first exact-plan-bound outcome bridge: reuse the qualified semantic acquire
and evolve skills plus the independent living-Pokedex verifier; authenticate the sealed V3 plan;
choose one frozen **train** trial before private execution; durably claim the trial and physical
root before controller input; execute only that candidate skill; retain failure/censoring; and
publish a path-free terminal. Mutation-test plan/trial/root binding, claim-before-action,
nonselected-skill exclusion, independent terminal observation, and no retry. Publish through
exact-source CI, execute exactly one train trial, then reorient before continuing the campaign.

Claude and Antigravity remain optional read-only milestone reviewers, not routine blockers or
duplicate implementers. Neither owns private execution. No agent owns freeze retry, claimed-trial
retry, teacher choice/fallback, development opening, fit, sealed Red, Crystal, promotion, replay,
completion, or transfer. Counters remain **development 15 · verified 5 · causal train 0/8 ·
fits 4/5 · comparisons 4/5 · authority 0 · transfer 0**.
...
## Previous override: Codex owned the zero-action Red shadow-decision design
...
records one consumed store-bound provision identity, four sealed V2 openings, zero evaluation
payload opens, and zero fit/comparison/counter effects. Antigravity returned GO with no P0/P1
blocker; Claude remains unavailable and is not a blocker.

Codex may perform only `rootless-living-dex-dependency-v2-compliance-fit-v1`: publish the exact
fit manifest, run one metadata-only preflight, and if it passes fit one clean replacement on the
eight public values. Stop at the first fit terminal. No development decode, comparison preflight
or execution, ROM/controller action, gameplay, promotion, completion, Crystal, or transfer is
owned. Keep **30/15/4/3/0/0**, development **14/4/0/1/1**, and rootless **8/8/1/0**.

## Previous override: Codex owned exactly one fresh V2 private provision
...
records that common inventory privately decoded all four development records, while publishing no
row content, and did not strictly join the loaded fit to all manifest semantic pins. The comparison
never ran. Its identity is unconsumed but ineligible; the completed fit remains counted but is
evaluation-ineligible.

Codex may modify only public/synthetic integrity tooling for
`rootless-living-dex-dependency-evaluation-integrity-qualification-v1`: add a metadata-only
commitment inspector, enforce the loaded-fit bundle join, mutation-test it, and stop. Reviewers are
read-only. No agent owns private access, reuse of the old fit/openings, fit, comparison,
ROM/controller action, promotion, Crystal, completion, or transfer. Keep **30/15/4/3/0/0**,
development **14/4/0/1/1**, and rootless **8/8/1/0**.

Do not call the historical result a comparison failure, claim the fit never occurred, infer that
development labels entered optimization, or assert an actual stored-record mismatch. Only exposure
and a missing semantic enforcement join are established.
...
## Previous override: Codex owned one aggregate comparison; qualification was later invalidated
...
recorded the exact completed fit, four commitments, and unused comparison identity with zero
development-payload disclosure at the time. The newer integrity receipt supersedes its disclosure
and readiness claims.

The comparison never ran. The old lane, identity, fit, and four decoded openings are retired
without retry or reuse.

## Previous override: Codex owned one zero-disclosure preflight; sealing claim later invalidated
...
records the consumed rootless fit: eight authenticated train rows, accuracy 1.0, and cross-entropy
0.693147→0.205636. Scoped fits are 1/1 and the comparison never ran. Its zero-development-
disclosure claim was later invalidated; gameplay, authority, completion, and transfer did not move.

That historical preflight instruction is superseded. No agent owns a refit, development payload
opening, comparison execution, ROM/game action, promotion, Crystal, completion, or transfer using
these artifacts.

## Previous override: Codex owned exactly one rootless dependency fit; sealing claim invalidated
...
records 8/8 settled synthetic rows, 4 positive, 4 negative, 0 interrupted, and all 12 identities
consumed. Its claim that four development openings remained sealed was later invalidated. Scoped
rootless outcomes and atomic episodes are 8/8. No gameplay, authority, or transfer changed.

The historical next step was the fixed train-only fit. It later completed and remains counted, but
its sealing and comparison-readiness claims are superseded.

## Previous override: Codex owned only the fixed train campaign; disclosure claim invalidated
...
records campaign `404e3a02…0bc9b92`, 12/12 unused global identities and 10/10 empty local
namespaces, with zero predictions, transitions, fits, or counter deltas. Its zero-development-
disclosure claim was later invalidated.

The historical next step was the exact eight-row train campaign. It later completed, but did not
retain a valid zero-disclosure boundary.
...
followed by restoration. Atomic episodes, acquisitions, and teacher queries were zero. Although 21
choices were recorded, the 19 from failed prefixes remain diagnostic-only and must not become fit
targets. See the
[V2 result receipt](../evidence/repeatable-goal-manager-development-result-v2-2026-08-18.json)
(SHA-256 `c7dde170…`).
...
outcomes, 0 atomic episodes, 1 composition attempt, and 1 verified composition**; the planned fit
has not happened. This is bounded teacher-free same-context Red development evidence, not reliable
gameplay, competence, completion, living-Pokédex ability, generalization, or transfer.

## Previous override: Codex owned direct execution of training-ready V2
...
and fail-closed orchestration only. They admitted no fresh root, loaded no prediction, sent no
controller input, and created no outcome. Counters remain **train 30 · development 15 · fits 3 ·
comparisons 3 · authority 0 · transfer 0**. See the
[path-free core qualification](../evidence/fresh-goal-manager-composition-core-qualification-v1-2026-08-17.json).

Codex owns only the maintenance lane
`fresh-goal-manager-composition-execution-qualification-v1`: action-free fresh-root admission; an
authenticated root-safe runner plus one-shot ledger; exact skill/protected-source attestation;
hard action/frame limiters; and a durable composition terminal. Runner qualification—not gameplay—
is next. Claude may audit source, claim, limiter, and terminal boundaries. Antigravity remains
deferred until a fresh executed Red result creates a concrete transfer question. No agent may run
the episode, patch a root or skill, reuse development, grant authority, or open sealed Red or
Crystal.

## Previous override: freeze the fresh goal-manager contract; do not execute it

Source `1395e446` passed CI run `32072706947`, attempt 1. The completed read-only postmortem found
six exact `raw_semantics_aliased_or_outcome_instability` clusters covering all 28 contradictory
relationships: 25 trainee and three venue. It found no projection-compression or tolerance-only
cluster and no isolated party-v2 repair. Venue cost range remained zero in all nine menus. No
outcome, fit, comparison, authority, transfer, development decode, or game-action counter moved.
...
Codex owns the design freeze for `fresh-goal-manager-composition-design-v1`, not its execution.
The contract must select the initial fresh nonsealed Red root action-free and before predictions;
contain exactly three decisions; expose at least two executable choices at each step; select three
distinct goal kinds including `ACQUIRE_SPECIES`; retain that capture; reobserve and verify after
every step and replan from the changed state; require confidence at least 0.80; use only existing
skills; and allow no teacher or fallback. If any condition cannot be met together, stop and
reorient instead of weakening it.

Claude may audit the frozen decision contract and its no-execution boundary. Antigravity remains
deferred until a fresh executed Red result creates a concrete architecture or transfer question.
No agent may refit party v2, reuse development, execute this episode during the design session,
grant authority, or open sealed Red or Crystal.

## Previous override: diagnose v2 once, then design a fresh goal-manager episode
...
Pokédex across versions, trades and legitimate event inputs. Red is the first curriculum. Crystal
is the first transfer test. The deterministic Red teacher is an oracle, verifier, demonstrator and
emergency safety authority; it is not the product.
...
Codex is the workhorse and the only default editor/pusher.

Codex owns:

- the active implementation plan and mission check;
- source, tests, private-safe tooling, dashboards and documentation;
- exact local validation, commits, pushes and GitHub CI diagnosis;
- private artifact creation only after the relevant review gate passes;
- reviewer adjudication: accept, reject or defer each finding with evidence;
- keeping handoff, roadmap, audit, narrative and video story synchronized;
- stopping maintenance that no longer unblocks a named learned experiment.

Codex does not outsource final judgment. Agreement between Claude and Antigravity is evidence, not
authority. If they disagree, Codex runs the cheapest discriminating test and records the result.
...
Codex deliverable at every gate: exact commit, source bundle, local tests, CI run, protected
counters, private-artifact status, accepted/rejected reviewer findings and the next bounded action.

Codex stop conditions:

- a second CI failure with the same diagnosed cause;
- a proposal to execute before the question/catalog is frozen;
- a proposed patch that improves Red only without a named transfer falsifier;
- more than one work session without a new learned decision or generalization result;
- any request for a full replay before the North Star full-run gate is complete.

## Role 2: Claude — forensic evidence and experiment auditor

Claude wants the forensic lane: prove that claims, datasets and tests mean what they say. Claude is
read-only by default and should attack an immutable commit rather than co-author implementation.

Claude owns review of:

- historical/current source provenance and receipt bindings;
- mutation resistance and independent semantic oracles;
- leakage, root/state overlap, partition integrity and post-outcome substitution;
- teacher/referee/actor separation and label validity;
- statistical power, denominators and whether a claimed result is identifiable;
- path-free failure evidence sufficient to reproduce a conclusion;
...
unavailable reasons, denominator integrity, one-shot durability and whether six development
decisions can support the exact conclusion proposed. Do not redesign the product architecture
unless a correctness defect requires it; that is Antigravity's primary lane.

Claude stop conditions:

- the reviewed head is dirty, moving or not the named CI-green commit;
- a required historical object is unavailable;
- a mutation harness changes the active worktree;
- evidence needed for a claim is private but not authorized for review;
- the requested verdict combines separate gates such as source qualification and live execution.

## Role 3: Antigravity — architecture and transfer challenger

Antigravity wants the product-red-team lane: decide whether a technically sound step actually moves
toward a transferable Pokémon player and living Pokédex. Antigravity is read-only by default.

Antigravity owns review of:

- whether work increases model authority or merely maintains Red;
- whether state, actions, goals and evidence remain title-neutral at the learner boundary;
- Red-specific shortcuts that will fail in Crystal or later generations;
- hierarchy boundaries among battle, navigation, party development, goals and collection;
- sample efficiency, decision density and simpler experiments;
- missing living-Pokédex capabilities: acquisition, evolution, storage, trade, version/event
...
3. whether the 66-feature party boundary contains the information Crystal needs without exposing
   Red identity;
4. whether depleted-PP materialization creates a useful resource decision or an artificial test;
5. whether the first fit has a concrete Crystal development falsifier;
6. whether the next dollar of work belongs in party learning, battle authority, local navigation,
...
a fair paired test. It may recommend retiring the transfer protocol. It may not open sealed Crystal
contexts or build a Crystal walkthrough.

Antigravity stop conditions:

- the input catalog has no genuine multi-candidate decisions;
- a proposed improvement succeeds by using the overlevelled starter more often;
- the transfer test changes the model, menus or normalizer between paired arms;
- a game-specific workaround appears before testing whether shared state lacks information;
- a second teacher script is proposed where a thin mechanics adapter should suffice.

## Gate-by-gate execution sequence

| Gate | Codex work | Claude decision | Antigravity decision | State change allowed |
| --- | --- | --- | --- | --- |
| 0. Published source | One approved CI history fix; docs; green exact head | None yet | None | Source only |
| 1. Source qualification | Freeze head and review packet | Provenance/mutation verdict | Optional mission sanity check | No private artifact |
| 2. Route 11 prior | Compose outside Git from authenticated receipts | Verify path-free summary if needed | Check that one prior is not overclaimed | Priors 0→1 only |
| 3. Question catalog | Read-only PP search; bounded materialization plan if needed; freeze 8+6 questions | Integrity/power audit | Choice quality/transfer audit | Menus 0→14; outcomes stay 0 |
| 4. Outcome collection | Execute each approved question once with durable private retention | Post-result evidence audit | Product-value audit | Outcomes may reach 14 |
| 5. Descriptive fit | Fit on 8 train; paired evaluation on 6 development; dashboard | Statistical/claim audit | Decide highest-leverage next skill | Fit count 0→1; authority stays 0 |
| 6. Skill gate | Expand genuine party contexts toward Milestone 4's 120 paired Red episodes | Promotion-evidence audit | Crystal development falsifier | Bounded party authority only after gate |
| 7. Hierarchy | Integrate qualified battle/navigation/party/goal heads in short episodes | Intervention and evidence audit | Living-Pokédex architecture audit | Multi-skill authority, still no full run |
| 8. Transfer | Thin Crystal adapter and frozen paired protocol | Partition/statistical audit | Transfer/adapter audit | Crystal only when protocol authorizes |
| 9. Final exams | Full Red then multi-title completion only under North Star gate | Result integrity | Product/generalization verdict | Promotion only from preregistered evidence |

## Phase mission checks

### Gates 0–2: source and prior

- Capability: trustworthy reuse of measured venue behavior across source revisions.
- Learned authority: none; bounded maintenance for the party experiment.
- Transfer test: the same compatibility/evidence contract must accept another title's adapter
  without adding title identity to the shared schema.
- Cheapest falsifier: one unlisted operational AST change must stop composition.
- Time box: one CI repair, one Claude audit, one composition.
- Stop condition: any surviving provenance mutation or non-reproducible historical object.

### Gates 3–5: first completion-aware party fit

- Capability: choose trainee and venue from completion, evolution, survival and resource state.
- Learned authority: descriptive trainee/venue preference only; no live authority yet.
- Transfer test: frozen Red initialization versus a zero-initialized control on separately declared
  Crystal development contexts before any sealed transfer result.
- Cheapest falsifier: a three-candidate unseen Red decision where the prior/update disagree and the
  measured outcome favors the baseline.
- Time box: one 8+6 catalog, one execution, one fit; no repeated tuning on six development rows.
- Stop condition: catalog lacks genuine choices/diversity, evidence fails to join, or development
  is choice-equivalent/underpowered.

### Gates 6–8: authority and transfer

- Capability: efficient party development inside a hierarchical player and across titles.
- Learned authority: trainee, venue, fight/rotate/heal/stop and evolution scheduling after the
  Milestone 4 gate; later goal selection and skill invocation.
- Transfer test: frozen paired Crystal protocols with identical menus, normalizers and controls.
- Cheapest falsifier: one randomized short Crystal scenario exposing missing shared information.
- Time box: one bounded skill gate or transfer protocol per checkpoint; no full replay as a probe.
- Stop condition: Red gains come from overlevelling, Crystal needs route-specific code, or two
  iterations fail the declared unseen/transfer metric.

## Universal prohibitions

Unless a newer, higher-authority protocol explicitly opens the gate, no agent may:

- execute or inspect sealed Red or Crystal cases;
- run a full game;
- query a teacher for an expected answer during outcome collection;
- replace a failed or exposed identity;
- commit ROMs, saves, datasets, models, private paths or private registry contents;
