...
[Session, review and evidence](../../docs/work-sessions/2026-09-10-collection-continuation.md).
...
[Session, evidence and next steps](../../docs/work-sessions/2026-09-10-qualified-status-recovery.md).
...
[Session and next step](../../docs/work-sessions/2026-09-10-capture-to-evolution.md).
...
The actor chooses goals and destinations; deterministic skills still execute mechanics. Historical114 remains separate. No learned combat, independent reliability or transfer claim.
[Session and next step](../../docs/work-sessions/2026-09-10-indoor-departure.md).
...
[Session and exact continuation](../../docs/work-sessions/2026-09-10-native-stock-overnight.md).
...
[Session, actual outcomes and continuation](../../docs/work-sessions/2026-09-10-owned-evolution-options.md).
...
[Session and exact continuation](../../docs/work-sessions/2026-09-10-capture-efficiency.md).
...
[Session, evidence and continuation](../../docs/work-sessions/2026-09-10-planning-throughput.md).
...
[Session, evidence, continuation and review decisions](../../docs/work-sessions/2026-09-10-transform-capture.md).
...
[Session, review and next steps](../../docs/work-sessions/2026-09-09-shared-registration-foundation.md). No external-agent audit or usage this session.
...
[Adopted scope and next steps](../../docs/shared-pokedex-registration-plan.md). No external agent audit or usage this session.
...
[Session, evidence and handoff](../../docs/work-sessions/2026-09-09-capture-fly-access.md). 367 focused tests, typing and lint passed. No external-agent review or usage this session.
...
architecture expansion. [Review and budget record](../../docs/work-sessions/2026-09-09-phase5-agent-package.md).
...
authenticated. [Closeout audit](../../docs/audits/red-phase4-closeout-2026-09-09.md).
...
lesson. [Next-session plan](../../docs/work-sessions/2026-09-09-phase5-collection-plan.md).
...
See [failure, repair and next-session audit](../../docs/audits/red-model-led-league-stop-2026-09-09.md).
...
See [fit audit](../../docs/audits/red-agatha-controller-fit-2026-09-09.md). Internal review found no critical probe-loader blocker;
...
Lance choice gate are unchanged. See [the CI diagnosis](../../docs/audits/ci-battle-fingerprint-2026-09-09.md).
...
See [the curriculum contract](../../docs/story-outcome-curriculum.md).
...
22 controller actions / 2,184 frames. One Full Restore was consumed; one remains.
All 30 specimens, 28 living species, 33 registered species and 6,163 currency
are preserved. The party is now entirely above half health. Bruno was not attempted.

The actual outcome entered model78: 78 settled outcomes, 36 successful and
68 distinct selected feature rows. All prior77 rows remain. Model SHA9ab7411f;
retained state2d1e3033, checkpoint record054f8cbd, trajectory cde902f8.
Episode: red-postfit-choice-20260909-01-causal. Source b8aae554 was unchanged.
Do not rerun this consumed choice or restart from historical11ff52b0.

This is real bounded goal-manager training, not learned full-game completion.
The fixed skills still own controller execution. Model78 has no post-fit gameplay.
In-sample error is slightly higher than the prior on the same expanded corpus;
there is no measured model advantage, independent evaluation or promotion.

Coverage audit of model77 found four selected successful restoration outcomes,
but only one selected failed story/access outcome. Its low story prediction is
poorly supported extrapolation, not proof that Bruno is impossible. Both recent
heals addressed sub-half-health Pokémon; that is not yet proof of reward gaming.
Now the largest remaining deficit is only18 HP, so preserving the last Full Restore
and collecting actual story experience take priority over further healing fits.

Next: qualify a generic prospective last-item readiness reserve and an explicitly
logged story-coverage curriculum from2d1e/model78. Preserve historical V4 replay,
use actual outcomes only, and do not seed-shop. If only one action is admissible,
report support rather than a learned choice; current choice fitting still excludes
forced singletons. Any separate skill-outcome curriculum needs a prospective
design, not retroactive admission of historical support. Stop after one bounded
story outcome or a named pre-input blocker. No teacher factory or full replay.

146 focused gameplay/training tests passed; zero-input saved-state audit checked
HP, item cost and unchanged save bytes. This is not a full-suite claim.
Income-to-story remains1/3; no stage exits or North Star goals changed.
Flash High CLI was queried, but its response was not recoverable after context
rollover, so no external conclusions are relied on. Five-hour and weekly quotas
are unavailable. Claude was not dispatched. Codex owns review and publication.
Next recommendation: Astra High, Fast off for bounded curriculum and verification.

## Historical — one genuine readiness lesson fitted; model77
...
See [native learning audit](../../docs/audits/red-native-choice-integration-2026-09-08.md).
...
See [confusion recovery audit](../../docs/audits/red-confusion-recovery-2026-09-08.md).
...
[Audit](../../docs/audits/red-flexible-trainer-preparation-2026-09-08.md).
...
[Audit and remaining Phase4 work](../../docs/audits/red-regional-income-qualification-2026-09-08.md).
...
[Audit and next steps](../../docs/audits/red-trainer-transition-qualification-2026-09-08.md).
...
[Detailed audit and next steps](../../docs/audits/red-trainer-funding-runtime-2026-09-08.md).
...
[Verified result](../../docs/evidence/red-phase3-chain-05-2026-09-08.json).
...
[Failure audit and next work](../../docs/audits/red-retained-ekans-failure-2026-09-08.md).
...
[Audit and next step](../../docs/audits/red-useful-precursor-practice-2026-09-08.md).
...
[Audit](../../docs/audits/red-alternative-acquisition-2026-09-08.md).
[Next session](../../docs/work-sessions/2026-09-08-safe-travel-stop-plan.md).
...
[Audit](../../docs/audits/red-remaining-acquisition-demand-2026-09-08.md).
[Next session](../../docs/work-sessions/2026-09-08-alternate-precursor-acquisition-plan.md).
...
Details and quotas: [bounded-search audit](../../docs/audits/red-bounded-search-continuation-2026-09-07.md).
...
[Audit](../../docs/audits/red-collection-prerequisites-learning-2026-09-07.md).
[Next plan](../../docs/work-sessions/2026-09-07-retained-collection-chain-plan.md).
...
[Audit](../../docs/audits/red-owned-precursor-bridge-2026-09-07.md).
[Next plan](../../docs/work-sessions/2026-09-07-collection-prerequisites-plan.md).
...
[Session audit](../../docs/audits/red-optional-recovery-learning-2026-09-07.md).
[Next plan](../../docs/work-sessions/2026-09-07-owned-precursor-choice-plan.md):
...
option's independently observed consequence. The Red adapter, collector, calibration gate, and
durable materializer now form one complete ROM-free boundary; read the
[adapter design](../../docs/red-living-dex-observed-arm-adapter.md),
[shared contract](../../docs/living-dex-option-value-contract.md), and
[redesign audit](../../docs/living-dex-option-value-redesign-audit-2026-08-25.md) before touching it.

The materializer was published from source
`98cfa01096e16b36c3f6b9a829d05ffa7293af36` through
[PR 54](https://github.com/PeteAndrews1289/pokemon-red-completion-agent/pull/54), passed exact-source
GitHub CI `32933786447/1`, and merged as main
`34a2c920c5e5a95bc4f29eaba18510d329815ed4`. Its
[path-free qualification](../../docs/evidence/red-living-dex-durable-materializer-qualification-v1-2026-08-26.json)
records **4,802 passed · 1 skipped · 3 deselected · 1 expected failure**, green Ruff, mypy,
documentation, privacy, focus, and registry gates, exact artifact hashes, zero protected effects,
and zero learning-counter deltas.

The load-bearing order is now durable: freeze and validate one complete 3+ row menu; claim the
scenario before issuing randomness; synchronize the one exact system-random selection before any
executor receives controller authority; execute only that authenticated semantic binding; bind one
fresh independent observation; and reload a complete terminal exactly after a fresh-process
restart. A process failure and an orphan recovered after power loss have different terminal labels,
but both are permanent and non-retryable. Tampered joins fail closed. Direct collector rows and
durable rehearsals retain synthetic provenance and cannot satisfy fit readiness; only byte-verified
authenticated captures can create counted examples.

This is still **engineering, not training**. No ROM or private capture was opened, no game action or
frame occurred, no outcome was collected, no model was fit, and no authority moved. Antigravity's
exact-commit audit returned `APPROVED WITH NOTES` with P0/P1 zero. Codex accepted its clarification
that the materializer and raw observation provenance are Red-specific, while the feature, outcome,
calibration, and later model contracts are the transferable layer. Crystal therefore needs its own
adapter into the shared contract, not reuse of Red memory facts. Claude was unavailable for a final
authenticated pass; no second verdict is claimed.

Active `repeatable-red-living-dex-option-value-calibration-v1` now permits exactly one **action-free
authenticated inventory and plan preflight**. Inspect only repeatable, nonsealed, unconsumed Red
captures; derive their complete menus and independent observer bindings; and freeze a path-free plan
only if it contains at least eight train scenarios across four genuine train option kinds and three
train transformation families plus four development scenarios disjoint from train by family and
location. Claims, random draws, controller inputs, frames, outcomes, and fitting must all remain
zero. Any provenance failure, duplicate or consumed root, incomplete menu, identity leakage, or
coverage shortfall closes this attempt for reorientation rather than weakening the gate.

Publish that exact plan/preflight boundary before separately authorizing real outcome collection.
The later 8+4 batch remains an integration and variance pilot: fit once on train, report development
descriptively, and make no policy-quality, transfer, or authority claim. Stop before a powered
...
Its only authorized action-free freeze stopped at the sanitized `action_free_root_inventory` stage.
The [failure receipt](../../docs/evidence/acquisition-replanning-campaign-freeze-failure-v1-2026-08-18.json)
records no campaign plan, preflight, prediction, controller action, outcome, fit, or gameplay. The
exact campaign is closed without retry, replacement root, menu repair, or skill repair; the stage
does not disclose a cause.

Codex now owns `goal-manager-acquisition-successor-learning-v1`. The
[frozen fit plan](../../docs/evidence/goal-manager-acquisition-successor-fit-plan-v1-2026-08-18.json)
allows exactly one offline update from candidate acquisition manifest `ca107bc2…cdf5`, initialized
from `eb5c6515…d2ce`. The existing storage/restoration pair supplies two evaluation-only
no-regression anchors; duplicate base manifest `094a4aae…e3a` and 19 failed prefixes supply no
gradient. No tuning, evaluation, promotion, or gameplay belongs here. Counters remain
**30/15/4/3/0/0** and **14/4/0/1/1**; scorecard **30/30 · 4/5 · 3/3**. On pass, move directly to
an 8-train/4-development root-disjoint one-decision curriculum; on failure, reject the exact fit.
...
attests the exact external source, runtime, model, context plan, NumPy, and PyBoy. It fixes the
campaign at exactly four authenticated nonsealed train roots and twelve trials, three per root,
behind a zero-action campaign freeze/preflight. A durable global claim must precede any model
prediction. Hard action and frame limits and strict propensity, identity, and living-collection
admission fail closed. Evolution is excluded until lineage evidence exists.

The candidate remains unpublished and unqualified. No campaign is frozen; no global claim,
prediction, controller action, frame, gameplay, outcome, episode, or fit exists. The legacy board
remains **train 30 · development 15 · fits 3 · comparisons 3 · authority 0 · transfer 0**, and all
five product-focus-v2 counters remain zero. Publish these exact candidate bytes, require green CI
on the exact published head, then freeze the exact campaign and run one zero-action preflight. Do
not call this checkpoint training-ready or treat it as gameplay, a fit, authority, or transfer.

## Previous checkpoint: V4 failed safely; qualify repeatable goal-manager development — 2026-08-17
...
`readiness_authentication` stage. The stage identifies no cause. The invocation wrote no
execution claim, authorized no execution identity, made no goal-manager decision or prediction,
sent no controller input, advanced no frame, and produced no gameplay, outcome, or episode. The
exact root is durably closed account-wide and may never retry. See the
[path-free V4 failure receipt](../../docs/evidence/fresh-goal-manager-composition-execution-preflight-v4-failure-2026-08-17.json).

The active maintenance lane is `repeatable-goal-manager-development-qualification-v1`. Its
candidate implementation remains under independent review, unpublished, and unqualified. The
[frozen design](../../docs/evidence/repeatable-goal-manager-development-design-v1-2026-08-17.json)
defines four authenticated nonsealed train roots and three trials per root, focused on story,
recovery, storage, and acquisition. A 15% exploratory mixture samples the learned distribution and
records exact behavior propensities. Verified success is +1, verified failure is -1, and an
interrupted choice is retained without an update target. Decisions and terminals are durable,
action and frame limits are hard, and teacher queries and fallbacks are zero.

Do not freeze a campaign before review and publication. After publication, the freeze and
zero-action preflight must pass before gameplay can be considered. The legacy board remains
**train 30 · development 15 · fits 3 · comparisons 3 ·
authority 0 · transfer 0**. Product-focus-v2 counters remain **development attempts 0 · verified
outcome examples 0 · atomic episodes 0 · composition attempts 0 · verified compositions 0**.

## Previous checkpoint: V3 failed at action-free admission; qualify the operational V4 successor — 2026-08-17
