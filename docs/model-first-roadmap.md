...
Current work is Red collection:58 verified registrations and54 examples under the registered-only learning objective. Earlier objectives and datasets remain historical; their counts are not silently added to this one. Fresh-game autonomous play and independent reliability are not established.
...
Public documentation cleanup comes first at Pete's request; it is maintenance, not learning. Resume from X/model54 after publication. A preparation-only profile found repeated history validation as a cost; any optimization needs measured benefit and unchanged integrity checks.
...
[Latest collection report](work-sessions/2026-09-10-collection-continuation.md) · [Historical roadmap](history/model-roadmap-through-2026-09-10.md)
