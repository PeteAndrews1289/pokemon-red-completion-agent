...
| Reserve-aware controller | Four complete clean-power lineages; 98.2394% held-out class accuracy / 94.7537% balance; frozen target head passed 17/17 fresh targets versus 12/17 baseline | Runtime artifact/binding, shadow, causal completion, and combined authority remain |
