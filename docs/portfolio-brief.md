...
| Repository gate | 2,187 tests, Ruff, mypy, public-artifact, documentation, and source-bound registry checks | 44 legacy modules remain in the explicit mypy debt register |
...
- How an emulator-scale system is tested without redistributing the ROM: 2,187 ROM-free tests plus
...
failed: the teacher required Brock-ready HP and PP but never visited a healer. The repair does not
lower the gate. It proves the level-9/Bubble lesson, visits the Pewter Center, authenticates full HP,
clear status, and restored PP, then applies the same readiness test at the Gym. This is a compact
...
- Hardened a 142k-line Python research system with 2,187 tests, Ruff, mypy, documentation/privacy
