...
| Strategic navigation data | Identity-free choice/outcome schema, reviewed vocabulary, authenticated trajectory join, 16 exact v2 contexts, six paired baseline disagreements and sealed test access | 0 counted train/validation examples; only 8/24 train and 8/12 validation contexts constructed; no frozen numeric schema, model, shadow result or causal authority |
