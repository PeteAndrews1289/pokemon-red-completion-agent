...
| Repository gate | 2,196 tests, Ruff, mypy, public-artifact, documentation, and source-bound registry checks | 44 legacy modules remain in the explicit mypy debt register |
...
- How an emulator-scale system is tested without redistributing the ROM: 2,196 ROM-free tests plus
...
- Hardened a 142k-line Python research system with 2,196 tests, Ruff, mypy, documentation/privacy
