...
The active registered-objective model has 63 examples from related development states. Those are not 63 independent games. In-sample fit quality and a successful collection batch cannot establish generalization.
