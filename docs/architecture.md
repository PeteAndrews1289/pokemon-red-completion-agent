...
| Trainee and venue strategy | Shared identity-free candidate scorer | 99.9004% sealed validation; isolated causal completion with 191 disagreements; portable Blaine completion with 400 disagreements | Still one captured Red training slice; candidate eligibility and mechanics remain fixed |
