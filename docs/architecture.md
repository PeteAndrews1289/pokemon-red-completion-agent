...
The active registered-objective model has56 examples from related development states. Those are not56 independent games. In-sample fit quality and a successful collection batch cannot establish generalization.
