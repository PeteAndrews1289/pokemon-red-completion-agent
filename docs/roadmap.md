...
> [model-first roadmap](model-first-roadmap.md). The current endpoint is Model118 with85 registrations
> and118 settled examples. The exact next restoration is frozen and unexecuted. Full fresh-run Red
