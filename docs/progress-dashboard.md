...
>
> **Current rail:** Show **PRODUCTION PROVIDER-PLAN FREEZER REHEARSED · 81 AUTHENTICATED CONTEXTS ·
> 4 CONSUMED · 9 NON-OVERWORLD · 68 ELIGIBLE CATALOG ROOTS + 1 HASH-BOUND OPEN CHECKPOINT · OLD
> PARTITIONS ARE PROVENANCE, NOT NEW LABELS · 15 RECIPES · 10 TRAIN + 5 DEVELOPMENT · 45 REAL
> OFFERS · 33 MECHANICS-DERIVED FAMILIES · 10 PHYSICAL ORIGINS · 7 CARTRIDGE CORRIDORS · 37
> PROVIDER ROUTES · ACTIONS/FRAMES/PROVIDER EXECUTIONS/CLAIMS/TEACHERS/PREDICTIONS/OUTCOMES/FITS/
> PUBLICATIONS 0 · PUBLISH + EXACT-HEAD CI + ONE ACTION-FREE FREEZE NEXT**. Link the
> [production rehearsal](evidence/red-living-dex-provider-plan-publication-disabled-rehearsal-2026-08-26.json),
...
> FREEZER REHEARSAL ✓ → PUBLISH EXACT SOURCE → EXACT-HEAD GREEN CI → FREEZE 15 RECIPES / 45 REAL
> OFFERS / 33 SEMANTIC FAMILIES / 10 PHYSICAL ORIGINS
> UNDER THE CLEAN EXECUTION IDENTITY →
> STOP/REORIENT → 15 CLAIMED SETUP
