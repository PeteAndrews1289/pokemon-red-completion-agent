...
>
> **Current rail:** Show **PUBLISHED EXACT SOURCE + GREEN CI → 12 ONE-USE WORLDS → 1/12 PASS →
> SUCCESSOR FREEZE CLOSED**. Group the eleven retained failures as **MT. MOON POTIONS 6 · SUPER
> NERD 2 · PEWTER NPC 1 · ZUBAT 1 · HIDEOUT PARTY 1**. Then show **CAPABILITY REPAIR → FINAL
> SOURCE 5285CCE4 → LOCAL 3/3 MANSION RETURNED · 115,696 ACTIONS · 21,246,875 FRAMES → FULL LOCAL
> QUALIFICATION: 5,657 TESTS · RUFF · MYPY 309 · REGISTRIES/DOCS/PUBLIC ARTIFACTS GREEN ·
> ANTIGRAVITY GO/P0 0/P1 0/P2 0 → PUBLISH → EXACT-MAIN CI → FUTURE SEEDS 9900049–9900060
> ONCE → REQUIRE ≥10/12 + NO REPEATED STAGE + NO LEAK**. On pass, continue **TRAIN-ONLY PLAN →
> MATERIALIZE ROOTS → ACTION-FREE RECENSUS → COLLECT CAUSAL OUTCOMES → GUARDED FIT**. Cross out
> **OLD V1 PLAN · ALL CONSUMED SEEDS · TEACHER BUTTONS AS LABELS · DEVELOPMENT · SEALED RED ·
> CRYSTAL NOW · REPLAY**. Keep **CAUSAL TRAIN 1/60 · POWERED FIT 0 · AUTHORITY 0 · TRANSFER 0**
> visible.
>
