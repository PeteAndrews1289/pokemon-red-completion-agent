...
>
> **Current rail:** Show **PR 108 → MAIN 00334DEC → CI 33292350018/1 GREEN → SUCCESSOR TRAIN 0
> CLAIMED ONCE → RANDOM COMMITMENT 1 → CONTROLLER ACTIONS 5,178 → EMULATOR FRAMES 257,093 →
> SELECTED-ARM CAUSAL TARGET 1 → TEACHERS/COUNTERFACTUALS/UNSELECTED TARGETS/DEVELOPMENT/
> PREDICTIONS/FITS/RETRIES 0 → DURABLE TERMINAL**. Continue **PATH-FREE RESULT → EXACT-MAIN CI →
> UNTOUCHED ORDINAL 1 EXACTLY ONCE → REORIENT → IF 8+, TEST SUPPORT + INFORMATION GATES →
> NON-AUTHORITATIVE FIT → 60 → UNTOUCHED RED → FROZEN SUPPORTED REPRESENTATION → CRYSTAL →
> CROSS-GAME LIVING POKEDEX**. Keep **CAUSAL TRAIN 7/60 · POWERED FIT 0 · AUTHORITY 0 · TRANSFER
> 0** visible. Cross out **ORDINAL 0 RETRY · ANOTHER PREFLIGHT · WRAPPER · CENSUS · ROUTE REPAIR ·
> DEVELOPMENT · TEACHER TARGET · FULL REPLAY · CRYSTAL NOW**. Link the
