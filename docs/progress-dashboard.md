...
>
> **Current rail:** Show **SAME-ROOT SETUP RECIPE V1 · LOCAL QUALIFICATION GREEN · PUBLICATION
> PENDING · 15 SLOTS · 10 TRAIN + 5 DEVELOPMENT · 45 PROVIDER RECIPES · 10 PHYSICAL ORIGIN-MAP
> SCOPES · EXACT SOURCE-ROOT BYTES AUTHENTICATED · CONSTRUCT ONCE · RESTORE IDENTICAL ORIGIN BEFORE
> EVERY ARM · OPTIONAL SEMANTIC ROUTE · FRESH REAL PROVIDER OFFER · EXPECTED FAMILY FROZEN BEFORE
> INPUT · FINAL RESTORE · CLAIM BEFORE RUNTIME · RETRY NO · EXACT PRIVATE CAPTURE RECOVERY ·
> PROVIDER EXECUTIONS/LEARNER EFFECTS 0 · 26 DIRECT / 156 RELATED / 5,137 FULL-SUITE TESTS GREEN ·
> GITHUB PUBLICATION PENDING**. Link the
> [local qualification](evidence/red-living-dex-same-root-setup-recipe-v1-local-qualification-2026-08-26.json),
...
>
> Animate active `repeatable-red-living-dex-option-value-calibration-v1`: **PUBLISH SAME-ROOT
> CONTRACT → INVENTORY GENUINE PROVIDER FAMILIES → TARGET-SPECIFIC EVOLUTION + DEVELOPMENT OFFERS →
> FREEZE 15 RECIPES / 45 REAL ARMS / 10 ORIGIN MAPS BEFORE INPUT → STOP/REORIENT → 15 CLAIMED SETUP
