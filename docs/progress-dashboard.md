...
> Put the immediate branch underneath: **PUBLIC QUALIFIED ROOT UPPER BOUND 67 → TRAIN DEFICIT AT
> LEAST 23 → COMBINED DEFICIT AT LEAST 128 → PUBLISH → ACTION-FREE MAXIMUM MATCHING CENSUS → FRESH
> PROSPECTIVE HARNESS EPISODES → COLLECT TRAIN FIRST**. Cross out **CLONE AS INDEPENDENCE · RNG
> REHASH AS INDEPENDENCE · DEVELOPMENT-TO-TRAIN · ONE-ROW FIT · SEALED RED · CRYSTAL NOW ·
> REPLAY**. Link the
> [capacity bound](evidence/living-dex-causal-public-capacity-bound-v1-2026-08-27.json) and
