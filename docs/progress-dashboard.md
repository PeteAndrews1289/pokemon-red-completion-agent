...
>
> **Current rail:** Show **SAME-ROOT TRUST REPAIR QUALIFIED · SOURCE 539454F3 · PR 78 · CI
> 33009960617/1 GREEN · SEALED RED EXECUTION IDENTITY · FRESH RUNTIME PER ARM · EXACT LOAD/SAVE
> READBACK · CONCRETE ROUTE EXECUTE + VERIFY · REGISTRY-BUILT OFFER · PROVIDER EXECUTION 0 · FULL
> EFFECT METER · TYPED MECHANICS-BASED FAMILY · COMPLETE PROOF TREE · CLOSED PUBLIC FAILURES ·
> BYTE-DERIVED ACCOUNT-WIDE ROOT CLAIM · SECOND POWER LOSS RECOVERS CLOSED · 147 FOCUSED / 5,174
> FULL-SUITE / 279 TYPED SOURCE FILES**. Link the
> [repair qualification](evidence/red-living-dex-same-root-trust-boundary-repair-v2-qualification-2026-08-26.json),
...
> PROVIDER FAMILIES ACTION-FREE → TARGET-SPECIFIC EVOLUTION + DEVELOPMENT OFFERS → FREEZE 15
> RECIPES / 45 REAL OFFERS / ≥33 SEMANTIC FAMILIES / 10 PHYSICAL ORIGINS BEFORE INPUT →
