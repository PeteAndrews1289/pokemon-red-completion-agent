...
>
> **Current rail:** Show **PR 90 GREEN → EXECUTABLE MAIN 6FD2286F → EXACT-MAIN CI 33118840112/1
> GREEN → FROZEN RED TRAIN LESSON · UNCONSUMED → CURRENT MAIN/CI + PRIVATE ARGUMENT AUTH → EXECUTE
> ONCE → SETTLED: CAUSAL TRAIN 1/1 / TARGET-FREE: CONSUMED 0/1 → STOP + REORIENT**. Cross out
> **REFREEZE · REROLL · RETRY · PREFLIGHT · WRAPPER · ONE-ROW FIT · SEALED RED · CRYSTAL · REPLAY**.
> Link the
> [reorientation](evidence/red-living-dex-causal-execution-reorientation-v1-2026-08-27.json) and
> keep **DEVELOPMENT 15 · VERIFIED 5 · CAUSAL TRAIN 0/1 · FITS 4 · COMPARISONS 4 · AUTHORITY 0 ·
> TRANSFER 0** visible until an authentic terminal changes it.
>
