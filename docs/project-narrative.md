...
| The forced-switch repair advanced v7 through Forest, Silph, and Sabrina to checkpoint 271, where Cinnabar rejected a twenty-slot effective bag. | The two additional early Potions occupied no new slot when purchased, but an unused Potion stack survived much farther than the former route and became obsolete beside the full late-game inventory. The capacity planner supported at most nineteen inputs. | The existing Cinnabar cleanup now sells the exact leftover Potion stack, verifies its removal and half-price proceeds, then preserves the qualified Antidote cleanup and delayed TM38 capacity proof. This propagates the larger reserve through its complete inventory lifecycle; the failed rehearsal remains uncounted. |
