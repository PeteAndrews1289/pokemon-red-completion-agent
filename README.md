...
- The latest verified collection contains **59 registered species**. The current registered-objective model has **56 training examples**; this is a small development dataset, not a measure of general intelligence.
...
The [latest collection report](docs/work-sessions/2026-09-10-post-merge-collection.md) and [story-completion audit](docs/audits/red-phase4-closeout-2026-09-09.md) explain exactly what ran.
