...
[![Status: Foundation](https://img.shields.io/badge/status-foundation-f59e0b.svg)](docs/roadmap.md)
...
> **Current status:** foundation work has begun. This repository does not yet claim a game
> completion. The first release establishes the contract, typed objective graph, deterministic
> navigation, safety boundaries, and specialist interfaces required to build a reliable teacher.
