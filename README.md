...
- The latest measured collection contains **83 registered species**. The registered-objective model has **111 settled examples**. Its last two four-way fishing choices produced one verified capture and one retained route failure; both became training rows. These are bounded same-lineage results, not independent full-game competence.
