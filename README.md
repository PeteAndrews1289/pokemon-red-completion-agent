...
- The latest verified collection contains **61 registered species**. The current registered-objective model has **60 training examples**; this is a small development dataset, not a measure of general intelligence. The latest evolution added a registration, not a new training example.
...
The [latest collection report](docs/work-sessions/2026-09-10-owned-evolution-access.md) and [story-completion audit](docs/audits/red-phase4-closeout-2026-09-09.md) explain exactly what ran.
